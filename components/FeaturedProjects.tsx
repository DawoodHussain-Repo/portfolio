...
const featuredProjects = [
  {
    ...
    date: '2024',
    description: 'Engineered financial forecasting platform with LSTM, GRU, and ARIMA models for stock, crypto, and forex predictions',
    highlights: [
  ...
  },
  {
    ...
    date: 'June 2025',
    description: 'Built full-stack SaaS platform for AI-powered educational companions with authentication and premium features',
    highlights: [
    ...
    stack: ['Next.js', 'React 19', 'Tailwind CSS', 'Supabase', 'Vapi AI', 'Clerk', 'Sentry'],
  ...
  },
  {
    ...
    date: '2024',
    description: 'Designed secure messaging app with AES-256-GCM encryption, ECDH key exchange, and zero-knowledge architecture',
    highlights: [
      'Built RESTful API with Express.js and MongoDB',
      'Implemented Socket.io for real-time encrypted delivery',
      'End-to-end encryption with zero-knowledge architecture'
    ],
    stack: ['React.js', 'Node.js', 'Express', 'MongoDB', 'Socket.io', 'Web Crypto API', 'Tailwind CSS'],
  ...
  },
  {
    ...
    date: 'Dec 2024',
    description: 'Developed full-stack airline operations system with role-based access control and CRUD operations',
    highlights: [
      'Built RESTful API with Node.js/Express',
      'Integrated JWT authentication',
      'Stripe payment processing integration'
    ],
    stack: ['React', 'Node.js', 'Express', 'MongoDB', 'JWT', 'Tailwind CSS', 'Stripe'],
  ...
  },
  {
    ...
    date: 'March 2025',
    description: 'Built AI educational platform with Flask backend using LangGraph/LangChain for agent orchestration',
    highlights: [
    ...
    stack: ['Flask', 'LangGraph', 'LangChain', 'ChromaDB', 'Sentence Transformers'],
    ...
    <section className="featured-projects" id="work">
      <div className="section-header">
        ...
        <p className="section-subtitle">
          A showcase of my technical projects demonstrating full-stack development, AI/ML integration, and modern web technologies
        </p>
      </div>
